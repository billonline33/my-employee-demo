                ...
                <div >
                    ...
                    <div className={"floatLeft"} style={paddingStyle}>
                        <SplitButton bsSize="large" title={`${sortByField} `}>
                            <MenuItem eventKey="First Name" onSelect={this.handleSortByChange}>First Name</MenuItem>
                            <MenuItem eventKey="Last Name" onSelect={this.handleSortByChange}>Last Name</MenuItem>
                        </SplitButton>
                    </div>
                </div>
            </div>
